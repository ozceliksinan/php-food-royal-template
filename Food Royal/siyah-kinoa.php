...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/siyah-kinoa.css" />
    <link rel="stylesheet" type="text/css" href="../CSS/siyah-kinoa_m.css" media="screen and (max-width: 50rem)" />
...
<body onload="SayfaYukle('siyah-kinoa');
...
<section id="siyah-kinoa_header" data-tagtype="subpage" class="secHeader"></section>
...
<section class="secSlider">
    ...
    <div class="divSliderContainer">
        ...
        <div class="divSliderImgs">
            <div class="divUrunSideImg"><img data-src="../img/urun_kinoa_siyah_side.png"></div>
        ...
        <div class="divSliderContent">
            <div class="divTexts">
                <div class="divText">
                    <span id="siyah-kinoa_baslik1"></span>
                    <p id="siyah-kinoa_text1"></p>
                </div>
                <div class="divText">
                    <span id="siyah-kinoa_baslik2"></span>
                    <p id="siyah-kinoa_text2"></p>
                </div>
            </div>
...
<section class="secOzellikler">
    <div class="divOzellikler">
        ...
        <div class="divOzellik1"><span id="siyah-kinoa_tabloBaslik"></span></div>
            <div class="divOzellik2">
                <div class="divOzellikRow"><span id="siyah-kinoa_row1_1"></span><span id="siyah-kinoa_row1_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-kinoa_row2_1"></span><span id="siyah-kinoa_row2_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-kinoa_row3_1"></span><span id="siyah-kinoa_row3_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-kinoa_row4_1"></span><span id="siyah-kinoa_row4_2"></span></div>
            </div>
            <div class="divOzellik3">
                <div class="divOzellikRow"><span id="siyah-kinoa_row5_1"></span><span id="siyah-kinoa_row5_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-kinoa_row6_1"></span><span id="siyah-kinoa_row6_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-kinoa_row7_1"></span><span id="siyah-kinoa_row7_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-kinoa_row8_1"></span><span id="siyah-kinoa_row8_2"></span></div>
            </div>
            <div class="divOzellik4">
                <div class="divOzellikRow"><span id="siyah-kinoa_row9_1"></span><span id="siyah-kinoa_row9_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-kinoa_row10_1"></span><span id="siyah-kinoa_row10_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-kinoa_row11_1"></span><span id="siyah-kinoa_row11_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-kinoa_row12_1"></span><span id="siyah-kinoa_row12_2"></span></div>
            </div>
...
<section class="secTarihce">
    ...
    <div class="divTarihce">
        <span id="siyah-kinoa_spTarihBaslik"></span>
        <p id="siyah-kinoa_pTarihce"></p>
    </div>
...
<section class="secTarif">
    ...
    <div class="divTarifSlogan"><span id="siyah-kinoa_tarifSlogan"></span></div>
    <div class="divTarifBaslik"><img data-src="../img/siyahKinoaBaslikBack.png"><span id="siyah-kinoa_tarifBaslik"></span></div>

    <div class="divTarif">

        <div class="divTarifTexts">
            <div class="divTarifText">
                <span id="siyah-kinoa_malzemeBaslik"></span>
                <p id="siyah-kinoa_malzemeText"></p>
            </div>
            <div class="divTarifText">
                <span id="siyah-kinoa_yapilisBaslik"></span>
                <p id="siyah-kinoa_yapilisText"></p>
            </div>
        </div>
        <div class="divTarifImg"><img data-src="../img/siyahKinoaTarif.jpg"></div>
    </div>


</section>
<section class="secVideo">
    <p id="siyah-kinoa_videoSlogan"></p>
    <div class="divVideo" id="siyah-kinoa_videoembedded">
    </div>
</section>
...
<section class="secDiger">
     <div class="divDigerLink">
        ...
        <p id="siyah-kinoa_digerText"></p>
        <div class="divDigerBtn">
            <img data-src="../img/digerBtnBack.png">
            <a href="#" target="_blank"><span id="siyah-kinoa_digerBtn"></span></a>
        </div>
    </div>
</section>

<section id="siyah-kinoa_footer" data-tagtype="subpage" class="secFooter"></section>
