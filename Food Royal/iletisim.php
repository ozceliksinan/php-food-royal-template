...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/iletisim_m.css" media="screen and (max-width: 50rem)" />
...
<body onload="SayfaYukle('iletisim');
...
<section id="iletisim_header" data-tagtype="subpage" class="secHeader"></section>
...
<section class="secIletisim">

    <div class="divContainer">

        <div class="divBaslik"><span id="iletisim_spBaslik"></span></div>
        <div class="divText"><p id="iletisim_pMerkez"></p></div>
        <div class="divText"><p id="iletisim_pFabrika"></p></div>
...
<section id="iletisim_footer" data-tagtype="subpage" class="secFooter"></section>
