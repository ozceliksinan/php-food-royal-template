...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/siyah-fasulye.css" />
    <link rel="stylesheet" type="text/css" href="../CSS/siyah-fasulye_m.css" media="screen and (max-width: 50rem)" />
...
<body onload="SayfaYukle('siyah-fasulye');
...
<section id="siyah-fasulye_header" data-tagtype="subpage" class="secHeader"></section>
...
<section class="secSlider">
    ...
    <div class="divSliderContainer">
        ...
        <div class="divSliderImgs">
            <div class="divUrunSideImg"><img data-src="../img/urun_fasulye_siyah_side.png"></div>
        ...
        <div class="divSliderContent">
            <div class="divTexts">
                <div class="divText">
                    <span id="siyah-fasulye_baslik1"></span>
                    <p id="siyah-fasulye_text1"></p>
                </div>
                <div class="divText">
                    <span id="siyah-fasulye_baslik2"></span>
                    <p id="siyah-fasulye_text2"></p>
                </div>
            </div>
...
<section class="secOzellikler">
    <div class="divOzellikler">
        ...
        <div class="divOzellik1"><span id="siyah-fasulye_tabloBaslik"></span></div>
            <div class="divOzellik2">
                <div class="divOzellikRow"><span id="siyah-fasulye_row1_1"></span><span id="siyah-fasulye_row1_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-fasulye_row2_1"></span><span id="siyah-fasulye_row2_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-fasulye_row3_1"></span><span id="siyah-fasulye_row3_2"></span></div>
            </div>
            <div class="divOzellik3">
                <div class="divOzellikRow"><span id="siyah-fasulye_row4_1"></span><span id="siyah-fasulye_row4_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-fasulye_row5_1"></span><span id="siyah-fasulye_row5_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-fasulye_row6_1"></span><span id="siyah-fasulye_row6_2"></span></div>
            </div>
            <div class="divOzellik4">
                <div class="divOzellikRow"><span id="siyah-fasulye_row7_1"></span><span id="siyah-fasulye_row7_2"></span></div>
                <div class="divOzellikRow"><span id="siyah-fasulye_row8_1"></span><span id="siyah-fasulye_row8_2"></span></div>
            </div>
...
<section class="secTarihce">
    ...
    <div class="divTarihce">
        <span id="siyah-fasulye_spTarihBaslik"></span>
        <p id="siyah-fasulye_pTarihce"></p>
    </div>
...
<section class="secTarif">
    ...
    <div class="divTarifSlogan"><span id="siyah-fasulye_tarifSlogan"></span></div>
    <div class="divTarifBaslik"><img data-src="../img/siyahFasulyeBaslikBack.png"><span id="siyah-fasulye_tarifBaslik"></span></div>

    <div class="divTarif">

        <div class="divTarifTexts">
            <div class="divTarifText">
                <span id="siyah-fasulye_malzemeBaslik"></span>
                <p id="siyah-fasulye_malzemeText"></p>
            </div>
            <div class="divTarifText">
                <span id="siyah-fasulye_yapilisBaslik"></span>
                <p id="siyah-fasulye_yapilisText"></p>
            </div>
        </div>
        <div class="divTarifImg"><img data-src="../img/siyahFasulyeTarif.jpg"></div>
    </div>


</section>
<section class="secVideo">
    <p id="siyah-fasulye_videoSlogan"></p>
    <div class="divVideo" id="siyah-fasulye_videoembedded">
    </div>
</section>
...
<section class="secDiger">
     <div class="divDigerLink">
        ...
        <p id="siyah-fasulye_digerText"></p>
        <div class="divDigerBtn">
            <img data-src="../img/digerBtnBack.png">
            <a href="#" target="_blank"><span id="siyah-fasulye_digerBtn"></span></a>
        </div>
    </div>
</section>

<section id="siyah-fasulye_footer" data-tagtype="subpage" class="secFooter"></section>
