...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/amarant.css" />
    <link rel="stylesheet" type="text/css" href="../CSS/amarant_m.css" media="screen and (max-width: 50rem)" />
...
<body onload="SayfaYukle('amarant');
...
<section id="amarant_header" data-tagtype="subpage" class="secHeader"></section>
...
<section class="secSlider">
    ...
    <div class="divSliderContainer">
        ...
        <div class="divSliderImgs">
            <div class="divUrunSideImg"><img data-src="../img/urun_amarant_side.png"></div>
        ...
        <div class="divSliderContent">
            <div class="divTexts">
                <div class="divText">
                    <span id="amarant_baslik1"></span>
                    <p id="amarant_text1"></p>
                </div>
                <div class="divText">
                    <span id="amarant_baslik2"></span>
                    <p id="amarant_text2"></p>
                </div>
            </div>
...
<section class="secOzellikler">
    <div class="divOzellikler">
        ...
        <div class="divOzellik1"><span id="amarant_tabloBaslik"></span></div>
            <div class="divOzellik2">
                <div class="divOzellikRow"><span id="amarant_row1_1"></span><span id="amarant_row1_2"></span></div>
                <div class="divOzellikRow"><span id="amarant_row2_1"></span><span id="amarant_row2_2"></span></div>
                <div class="divOzellikRow"><span id="amarant_row3_1"></span><span id="amarant_row3_2"></span></div>
                <div class="divOzellikRow"><span id="amarant_row4_1"></span><span id="amarant_row4_2"></span></div>
            </div>
            <div class="divOzellik3">
                <div class="divOzellikRow"><span id="amarant_row5_1"></span><span id="amarant_row5_2"></span></div>
                <div class="divOzellikRow"><span id="amarant_row6_1"></span><span id="amarant_row6_2"></span></div>
                <div class="divOzellikRow"><span id="amarant_row7_1"></span><span id="amarant_row7_2"></span></div>
                <div class="divOzellikRow"><span id="amarant_row8_1"></span><span id="amarant_row8_2"></span></div>
            </div>
            <div class="divOzellik4">
                <div class="divOzellikRow"><span id="amarant_row9_1"></span><span id="amarant_row9_2"></span></div>
                <div class="divOzellikRow"><span id="amarant_row10_1"></span><span id="amarant_row10_2"></span></div>
                <div class="divOzellikRow"><span id="amarant_row11_1"></span><span id="amarant_row11_2"></span></div>
            </div>
...
<section class="secTarihce">
    ...
    <div class="divTarihce">
        <span id="amarant_spTarihBaslik"></span>
        <p id="amarant_pTarihce"></p>
    </div>
...
<section class="secTarif">
    ...
    <div class="divTarifSlogan"><span id="amarant_tarifSlogan"></span></div>
    <div class="divTarifBaslik"><img data-src="../img/amarantBaslikBack.png"><span id="amarant_tarifBaslik"></span></div>

    <div class="divTarif">

        <div class="divTarifTexts">
            <div class="divTarifText">
                <span id="amarant_malzemeBaslik"></span>
                <p id="amarant_malzemeText"></p>
            </div>
            <div class="divTarifText">
                <span id="amarant_yapilisBaslik"></span>
                <p id="amarant_yapilisText"></p>
            </div>
        </div>
...
<section class="secVideo">
    <p id="amarant_videoSlogan"></p>
    <div class="divVideo" id="amarant_videoembedded">
...
<section class="secDiger">
     <div class="divDigerLink">
        ...
        <p id="amarant_digerText"></p>
        <div class="divDigerBtn">
            <img data-src="../img/digerBtnBack.png">
            <a href="#" target="_blank"><span id="amarant_digerBtn"></span></a>
        </div>
    </div>
</section>

<section id="amarant_footer" data-tagtype="subpage" class="secFooter"></section>
