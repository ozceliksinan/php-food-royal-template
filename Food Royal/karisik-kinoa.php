...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/karisik-kinoa.css" />
    <link rel="stylesheet" type="text/css" href="../CSS/karisik-kinoa_m.css" media="screen and (max-width: 50rem)" />
...
<body onload="SayfaYukle('karisik-kinoa');
...
<section id="karisik-kinoa_header" data-tagtype="subpage" class="secHeader"></section>
...
<section class="secSlider">
    ...
    <div class="divSliderContainer">
        ...
        <div class="divSliderImgs">
            <div class="divUrunSideImg"><img data-src="../img/urun_kinoa_karisik_side.png"></div>
        ...
        <div class="divSliderContent">
            <div class="divTexts">
                <div class="divText">
                    <span id="karisik-kinoa_baslik1"></span>
                    <p id="karisik-kinoa_text1"></p>
                </div>
                <div class="divText">
                    <span id="karisik-kinoa_baslik2"></span>
                    <p id="karisik-kinoa_text2"></p>
                </div>
            </div>
...
<section class="secOzellikler">
    <div class="divOzellikler">
        ...
        <div class="divOzellik1"><span id="karisik-kinoa_tabloBaslik"></span></div>
            <div class="divOzellik2">
                <div class="divOzellikRow"><span id="karisik-kinoa_row1_1"></span><span id="karisik-kinoa_row1_2"></span></div>
                <div class="divOzellikRow"><span id="karisik-kinoa_row2_1"></span><span id="karisik-kinoa_row2_2"></span></div>
                <div class="divOzellikRow"><span id="karisik-kinoa_row3_1"></span><span id="karisik-kinoa_row3_2"></span></div>
                <div class="divOzellikRow"><span id="karisik-kinoa_row4_1"></span><span id="karisik-kinoa_row4_2"></span></div>
            </div>
            <div class="divOzellik3">
                <div class="divOzellikRow"><span id="karisik-kinoa_row5_1"></span><span id="karisik-kinoa_row5_2"></span></div>
                <div class="divOzellikRow"><span id="karisik-kinoa_row6_1"></span><span id="karisik-kinoa_row6_2"></span></div>
                <div class="divOzellikRow"><span id="karisik-kinoa_row7_1"></span><span id="karisik-kinoa_row7_2"></span></div>
                <div class="divOzellikRow"><span id="karisik-kinoa_row8_1"></span><span id="karisik-kinoa_row8_2"></span></div>
            </div>
            <div class="divOzellik4">
                <div class="divOzellikRow"><span id="karisik-kinoa_row9_1"></span><span id="karisik-kinoa_row9_2"></span></div>
                <div class="divOzellikRow"><span id="karisik-kinoa_row10_1"></span><span id="karisik-kinoa_row10_2"></span></div>
                <div class="divOzellikRow"><span id="karisik-kinoa_row11_1"></span><span id="karisik-kinoa_row11_2"></span></div>
                <div class="divOzellikRow"><span id="karisik-kinoa_row12_1"></span><span id="karisik-kinoa_row12_2"></span></div>
            </div>
...
<section class="secTarihce">
    ...
    <div class="divTarihce">
        <span id="karisik-kinoa_spTarihBaslik"></span>
        <p id="karisik-kinoa_pTarihce"></p>
    </div>
...
<section class="secTarif">
    ...
    <div class="divTarifSlogan"><span id="karisik-kinoa_tarifSlogan"></span></div>
    <div class="divTarifBaslik"><img data-src="../img/karisikKinoaBaslikBack.png"><span id="karisik-kinoa_tarifBaslik"></span></div>

    <div class="divTarif">

        <div class="divTarifTexts">
            <div class="divTarifText">
                <span id="karisik-kinoa_malzemeBaslik"></span>
                <p id="karisik-kinoa_malzemeText"></p>
            </div>
            <div class="divTarifText">
                <span id="karisik-kinoa_yapilisBaslik"></span>
                <p id="karisik-kinoa_yapilisText"></p>
            </div>
        </div>
        <div class="divTarifImg"><img data-src="../img/karisikKinoaTarif.jpg"></div>
    </div>


</section>
<section class="secVideo">
    <p id="karisik-kinoa_videoSlogan"></p>
    <div class="divVideo" id="karisik-kinoa_videoembedded">
    </div>
</section>
...
<section class="secDiger">
     <div class="divDigerLink">
        ...
        <p id="karisik-kinoa_digerText"></p>
        <div class="divDigerBtn">
            <img data-src="../img/digerBtnBack.png">
            <a href="#" target="_blank"><span id="karisik-kinoa_digerBtn"></span></a>
        </div>
    </div>
</section>

<section id="karisik-kinoa_footer" data-tagtype="subpage" class="secFooter"></section>
