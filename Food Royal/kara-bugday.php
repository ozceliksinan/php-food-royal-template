...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/kara-bugday.css" />
    <link rel="stylesheet" type="text/css" href="../CSS/kara-bugday_m.css" media="screen and (max-width: 50rem)" />
...
<body onload="SayfaYukle('kara-bugday');
...
<section id="kara-bugday_header" data-tagtype="subpage" class="secHeader"></section>
...
<section class="secSlider">
    ...
    <div class="divSliderContainer">
        ...
        <div class="divSliderImgs">
            <div class="divUrunSideImg"><img data-src="../img/urun_kara_bugday_side.png"></div>
        ...
        <div class="divSliderContent">
            <div class="divTexts">
                <div class="divText">
                    <span id="kara-bugday_baslik1"></span>
                    <p id="kara-bugday_text1"></p>
                </div>
                <div class="divText">
                    <span id="kara-bugday_baslik2"></span>
                    <p id="kara-bugday_text2"></p>
                </div>
            </div>
            ...
            <div class="divSloganlar">
                ...
                <div class="divSloganAlt">
                    <img data-osrc="../img/urun_ozellik_yag2">
...
<section class="secOzellikler">
    <div class="divOzellikler">
        ...
        <div class="divOzellik1"><span id="kara-bugday_tabloBaslik"></span></div>
            <div class="divOzellik2">
                <div class="divOzellikRow"><span id="kara-bugday_row1_1"></span><span id="kara-bugday_row1_2"></span></div>
                <div class="divOzellikRow"><span id="kara-bugday_row2_1"></span><span id="kara-bugday_row2_2"></span></div>
                <div class="divOzellikRow"><span id="kara-bugday_row3_1"></span><span id="kara-bugday_row3_2"></span></div>
            </div>
            <div class="divOzellik3">
                <div class="divOzellikRow"><span id="kara-bugday_row4_1"></span><span id="kara-bugday_row4_2"></span></div>
                <div class="divOzellikRow"><span id="kara-bugday_row5_1"></span><span id="kara-bugday_row5_2"></span></div>
                <div class="divOzellikRow"><span id="kara-bugday_row6_1"></span><span id="kara-bugday_row6_2"></span></div>
            </div>
            <div class="divOzellik4">
                <div class="divOzellikRow"><span id="kara-bugday_row7_1"></span><span id="kara-bugday_row7_2"></span></div>
                <div class="divOzellikRow"><span id="kara-bugday_row8_1"></span><span id="kara-bugday_row8_2"></span></div>
            </div>
...
<section class="secTarihce">
    ...
    <div class="divTarihce">
        <span id="kara-bugday_spTarihBaslik"></span>
        <p id="kara-bugday_pTarihce"></p>
    </div>
...
<section class="secTarif">
    ...
    <div class="divTarifSlogan"><span id="kara-bugday_tarifSlogan"></span></div>
    <div class="divTarifBaslik"><img data-src="../img/karabugdayBaslikBack.png"><span id="kara-bugday_tarifBaslik"></span></div>

    <div class="divTarif">

        <div class="divTarifTexts">
            <div class="divTarifText">
                <span id="kara-bugday_malzemeBaslik"></span>
                <p id="kara-bugday_malzemeText"></p>
            </div>
            <div class="divTarifText">
                <span id="kara-bugday_yapilisBaslik"></span>
                <p id="kara-bugday_yapilisText"></p>
            </div>
        </div>
        <div class="divTarifImg"><img data-src="../img/karabugdayTarif.jpg"></div>
    </div>


</section>
<section class="secVideo">
    <p id="kara-bugday_videoSlogan"></p>
    <div class="divVideo" id="kara-bugday_videoembedded">
    </div>
</section>
...
<section class="secDiger">
     <div class="divDigerLink">
        ...
        <p id="kara-bugday_digerText"></p>
        <div class="divDigerBtn">
            <img data-src="../img/digerBtnBack.png">
            <a href="#" target="_blank"><span id="kara-bugday_digerBtn"></span></a>
        </div>
    </div>
</section>

<section id="kara-bugday_footer" data-tagtype="subpage" class="secFooter"></section>
