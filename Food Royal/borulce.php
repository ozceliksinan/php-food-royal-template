...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/borulce.css" />
    <link rel="stylesheet" type="text/css" href="../CSS/borulce_m.css" media="screen and (max-width: 50rem)" />
...
<body onload="SayfaYukle('borulce');
...
<section id="borulce_header" data-tagtype="subpage" class="secHeader"></section>
...
<section class="secSlider">
    ...
    <div class="divSliderContainer">
        ...
        <div class="divSliderImgs">
            <div class="divUrunSideImg"><img data-src="../img/urun_borulce_side.png"></div>
        ...
        <div class="divSliderContent">
            <div class="divTexts">
                <div class="divText">
                    <span id="borulce_baslik1"></span>
                    <p id="borulce_text1"></p>
                </div>
                <div class="divText">
                    <span id="borulce_baslik2"></span>
                    <p id="borulce_text2"></p>
                </div>
            </div>
...
<section class="secOzellikler">
    <div class="divOzellikler">
        ...
        <div class="divOzellik1"><span id="borulce_tabloBaslik"></span></div>
            <div class="divOzellik2">
                <div class="divOzellikRow"><span id="borulce_row1_1"></span><span id="borulce_row1_2"></span></div>
                <div class="divOzellikRow"><span id="borulce_row2_1"></span><span id="borulce_row2_2"></span></div>
                <div class="divOzellikRow"><span id="borulce_row3_1"></span><span id="borulce_row3_2"></span></div>
                <div class="divOzellikRow"><span id="borulce_row4_1"></span><span id="borulce_row4_2"></span></div>
            </div>
            <div class="divOzellik3">
                <div class="divOzellikRow"><span id="borulce_row5_1"></span><span id="borulce_row5_2"></span></div>
                <div class="divOzellikRow"><span id="borulce_row6_1"></span><span id="borulce_row6_2"></span></div>
                <div class="divOzellikRow"><span id="borulce_row7_1"></span><span id="borulce_row7_2"></span></div>
            </div>
            <div class="divOzellik4">
                <div class="divOzellikRow"><span id="borulce_row8_1"></span><span id="borulce_row8_2"></span></div>
                <div class="divOzellikRow"><span id="borulce_row9_1"></span><span id="borulce_row9_2"></span></div>
                <div class="divOzellikRow"><span id="borulce_row10_1"></span><span id="borulce_row10_2"></span></div>
            </div>
...
<section class="secTarihce">
    ...
    <div class="divTarihce">
        <span id="borulce_spTarihBaslik"></span>
        <p id="borulce_pTarihce"></p>
    </div>
...
<section class="secTarif">
    ...
    <div class="divTarifSlogan"><span id="borulce_tarifSlogan"></span></div>
    <div class="divTarifBaslik"><img data-src="../img/borulceBaslikBack.png"><span id="borulce_tarifBaslik"></span></div>

    <div class="divTarif">

        <div class="divTarifTexts">
            <div class="divTarifText">
                <span id="borulce_malzemeBaslik"></span>
                <p id="borulce_malzemeText"></p>
            </div>
            <div class="divTarifText">
                <span id="borulce_yapilisBaslik"></span>
                <p id="borulce_yapilisText"></p>
            </div>
        </div>
        <div class="divTarifImg"><img data-src="../img/borulceTarif.jpg"></div>
    </div>
...
<section class="secVideo">
    <p id="borulce_videoSlogan"></p>
    <div class="divVideo" id="borulce_videoembedded">
    </div>
</section>
...
<section class="secDiger">
     <div class="divDigerLink">
        ...
        <p id="borulce_digerText"></p>
        <div class="divDigerBtn">
            <img data-src="../img/digerBtnBack.png">
            <a href="#" target="_blank"><span id="borulce_digerBtn"></span></a>
        </div>
    </div>
</section>

<section id="borulce_footer" data-tagtype="subpage" class="secFooter"></section>
