...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/kepekli-pirinc.css" />
    <link rel="stylesheet" type="text/css" href="../CSS/kepekli-pirinc_m.css" media="screen and (max-width: 50rem)" />
...
<body onload="SayfaYukle('kepekli-pirinc');
...
<section id="kepekli-pirinc_header" data-tagtype="subpage" class="secHeader"></section>
...
<section class="secSlider">
    ...
    <div class="divSliderContainer">
        ...
        <div class="divSliderImgs">
            <div class="divUrunSideImg"><img data-src="../img/urun_pirinc_kepekli_side.png"></div>
        ...
        <div class="divSliderContent">
            <div class="divTexts">
                <div class="divText">
                    <span id="kepekli-pirinc_baslik1"></span>
                    <p id="kepekli-pirinc_text1"></p>
                </div>
                <div class="divText">
                    <span id="kepekli-pirinc_baslik2"></span>
                    <p id="kepekli-pirinc_text2"></p>
                </div>
            </div>
...
<section class="secOzellikler">
    <div class="divOzellikler">
        ...
        <div class="divOzellik1"><span id="kepekli-pirinc_tabloBaslik"></span></div>
            <div class="divOzellik2">
                <div class="divOzellikRow"><span id="kepekli-pirinc_row1_1"></span><span id="kepekli-pirinc_row1_2"></span></div>
                <div class="divOzellikRow"><span id="kepekli-pirinc_row2_1"></span><span id="kepekli-pirinc_row2_2"></span></div>
                <div class="divOzellikRow"><span id="kepekli-pirinc_row3_1"></span><span id="kepekli-pirinc_row3_2"></span></div>
            </div>
            <div class="divOzellik3">
                <div class="divOzellikRow"><span id="kepekli-pirinc_row4_1"></span><span id="kepekli-pirinc_row4_2"></span></div>
                <div class="divOzellikRow"><span id="kepekli-pirinc_row5_1"></span><span id="kepekli-pirinc_row5_2"></span></div>
                <div class="divOzellikRow"><span id="kepekli-pirinc_row6_1"></span><span id="kepekli-pirinc_row6_2"></span></div>
                <div class="divOzellikRow"><span id="kepekli-pirinc_row7_1"></span><span id="kepekli-pirinc_row7_2"></span></div>
            </div>
            <div class="divOzellik4">
                <div class="divOzellikRow"><span id="kepekli-pirinc_row8_1"></span><span id="kepekli-pirinc_row8_2"></span></div>
                <div class="divOzellikRow"><span id="kepekli-pirinc_row9_1"></span><span id="kepekli-pirinc_row9_2"></span></div>
                <div class="divOzellikRow"><span id="kepekli-pirinc_row10_1"></span><span id="kepekli-pirinc_row10_2"></span></div>
                <div class="divOzellikRow"><span id="kepekli-pirinc_row11_1"></span><span id="kepekli-pirinc_row11_2"></span></div>
            </div>
...
<section class="secTarihce">
    ...
    <div class="divTarihce">
        <span id="kepekli-pirinc_spTarihBaslik"></span>
        <p id="kepekli-pirinc_pTarihce"></p>
    </div>
...
<section class="secTarif">
    ...
    <div class="divTarifSlogan"><span id="kepekli-pirinc_tarifSlogan"></span></div>
    <div class="divTarifBaslik"><img data-src="../img/kepekliPirincBaslikBack.png"><span id="kepekli-pirinc_tarifBaslik"></span></div>

    <div class="divTarif">

        <div class="divTarifTexts">
            <div class="divTarifText">
                <span id="kepekli-pirinc_malzemeBaslik"></span>
                <p id="kepekli-pirinc_malzemeText"></p>
            </div>
            <div class="divTarifText">
                <span id="kepekli-pirinc_yapilisBaslik"></span>
                <p id="kepekli-pirinc_yapilisText"></p>
            </div>
        </div>
        <div class="divTarifImg"><img data-src="../img/kepekliPirincTarif.jpg"></div>
    </div>


</section>
<section class="secVideo">
    <p id="kepekli-pirinc_videoSlogan"></p>
    <div class="divVideo" id="kepekli-pirinc_videoembedded">
    </div>
</section>
...
<section class="secDiger">
     <div class="divDigerLink">
        ...
        <p id="kepekli-pirinc_digerText"></p>
        <div class="divDigerBtn">
            <img data-src="../img/digerBtnBack.png">
            <a href="#" target="_blank"><span id="kepekli-pirinc_digerBtn"></span></a>
        </div>
    </div>
</section>

<section id="kepekli-pirinc_footer" data-tagtype="subpage" class="secFooter"></section>
